...
;// CONCATENATED MODULE: ./node_modules/cable_ready/javascript/active_element.js
let activeElement

/* harmony default export */ const active_element = ({
  get element () {
...
const assignFocus = selector => {
  ...
  const focusElement = element || active_element.element
...
;// CONCATENATED MODULE: ./node_modules/cable_ready/javascript/morph_callbacks.js
...
const verifyNotPermanent = (detail, fromEl, toEl) => {
  ...
  if (!permanent && isTextInput(fromEl) && fromEl === active_element.element) {
...
;// CONCATENATED MODULE: ./node_modules/cable_ready/javascript/operations.js




/* harmony default export */ const operations = ({
  // DOM Mutations
...
;// CONCATENATED MODULE: ./node_modules/cable_ready/javascript/operation_store.js


let operation_store_operations = operations

const add = newOperations => {
  operation_store_operations = { ...operation_store_operations, ...newOperations }
}
...
/* harmony default export */ const operation_store = ({
  get all () {
    return operation_store_operations
  }
});

;// CONCATENATED MODULE: ./node_modules/cable_ready/javascript/action_cable.js
let consumer

/* harmony default export */ const action_cable = ({
  setConsumer (value) {
    consumer = value
  }
});
      ...
      for (let i = 0; i < entries.length; i++) {
        ...
        try {
          ...
          if (operation.element || options.emitMissingElementWarnings) {
            active_element.set(document.activeElement)
            const cableReadyOperation = operation_store.all[name]
...
const initialize = (initializeOptions = {}) => {
  ...
  action_cable.setConsumer(consumer)
}



;// CONCATENATED MODULE: ./node_modules/cable_ready/javascript/stream_from_element.js
  ...
  connectedCallback () {
    ...
    if (consumer) {
      this.channel = consumer.subscriptions.create(
        ...
        {
          received (data) {
            if (data.cableReady) javascript.perform(data.operations)
          }
        }
      )
    } else {
...
;// CONCATENATED MODULE: ./node_modules/cable_ready/javascript/index.js
...
;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/deprecate.js
let deprecationWarnings = true

/* harmony default export */ const javascript_deprecate = ({
  get enabled () {
...
const getElementsFromTokens = (element, tokens) => {
  ...
  tokens.forEach(token => {
    try {
      switch (token) {
        case 'combined':
          if (javascript_deprecate.enabled)
            console.warn(
      ...
      if (javascript_debug.enabled) console.error(error)
    }
  })
...
const extractElementDataset = element => {
  const dataset = element.attributes[javascript_reflexes.app.schema.reflexDatasetAttribute]
  const allDataset =
    element.attributes[javascript_reflexes.app.schema.reflexDatasetAllAttribute]
...
;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/isolation_mode.js
let isolationMode = false

/* harmony default export */ const isolation_mode = ({
  get disabled () {
...
;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/reflexes.js
...
/* harmony default export */ const javascript_reflexes = (reflexes);
...
const received = data => {
  ...
  if (reflexData) {
    ...
    if (!reflexes[reflexId] && isolation_mode.disabled) {
...
const registerReflex = data => {
  ...
  if (javascript_debug.enabled) promise.catch(() => {})
...
const getReflexRoots = element => {
  ...
  while (list.length === 0 && element) {
    ...
    if (reflexRoot) {
      ...
      if (javascript_debug.enabled && selectors.length === 0) {
        console.error(
...
const invokeLifecycleMethod = (
  ...
  if (javascript_reflexes[reflexId] && stage === javascript_reflexes[reflexId].finalStage) {
...
const dispatchLifecycleEvent = (
  ...
  if (!controllerElement) {
    if (javascript_debug.enabled && !javascript_reflexes[reflexId].warned) {
      console.warn(
      ...
      javascript_reflexes[reflexId].warned = true
    }
    return
  }
...
function request (
  ...
  javascript_reflexes[reflexId].timestamp = new Date()
...
function success (event) {
  ...
  const reflex = javascript_reflexes[reflexId]
  const progress =
...
/* harmony default export */ const log = ({ request, success, error });

;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/callbacks.js
...
const afterDOMUpdate = event => {
  ...
  javascript.perform(reflex.piggybackOperations)
}
...
var javascripts_action_cable = __webpack_require__(877);
;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/transports/action_cable.js




let action_cable_consumer
let params
let subscriptionActive

const createSubscription = controller => {
  action_cable_consumer = action_cable_consumer || controller.application.consumer || (0,javascripts_action_cable.createConsumer)()
  ...
  controller.StimulusReflex.subscription =
    action_cable_consumer.subscriptions.findAll(identifier)[0] ||
    action_cable_consumer.subscriptions.create(subscription, {
      received: received,
      connected,
      rejected,
      disconnected
...
/* harmony default export */ const transports_action_cable = ({
  consumer: action_cable_consumer,
  params,
  ...
  set (consumerValue, paramsValue) {
    action_cable_consumer = consumerValue
    params = paramsValue
  }
});
...
//
const stimulus_reflex_initialize = (application, initializeOptions = {}) => {
  const {
    controller,
    consumer,
    debug,
  ...
  transports_action_cable.set(consumer, params)
  setTimeout(() => {
    if (javascript_deprecate.enabled && consumer)
      console.warn(
  ...
  isolation_mode.set(!!isolate)
  setTimeout(() => {
    if (javascript_deprecate.enabled && isolation_mode.disabled)
      console.warn(
  ...
  javascript_reflexes.app = application
  javascript_reflexes.app.schema = { ...defaultSchema, ...application.schema }
  javascript_reflexes.app.register(
    'stimulus-reflex',
    controller || StimulusReflexController
  )
  javascript_debug.set(!!debug)
  if (typeof deprecate !== 'undefined') javascript_deprecate.set(deprecate)
  const observer = new MutationObserver(setupDeclarativeReflexes)
  observer.observe(document.documentElement, {
    attributeFilter: [
      javascript_reflexes.app.schema.reflexAttribute,
      javascript_reflexes.app.schema.actionAttribute
    ],
    childList: true,
    subtree: true
  })
...
const register = (controller, options = {}) => {
  ...
  transports_action_cable.createSubscription(controller)
  Object.assign(controller, {
    ...
    stimulate () {
      ...
      const data = {
        ...
        permanentAttributeName: javascript_reflexes.app.schema.reflexPermanentAttribute
      }
      ...
      if (!transports_action_cable.subscriptionActive)
      ...
      setTimeout(() => {
        ...
        const serializeAttribute =
          reflexElement.attributes[
            javascript_reflexes.app.schema.reflexSerializeFormAttribute
          ]
        ...
        if (javascript_deprecate.enabled && options['serializeForm'] === undefined && form)
          console.warn(
            `Deprecation warning: the next version of StimulusReflex will not serialize forms by default.\nPlease set ${javascript_reflexes.app.schema.reflexSerializeFormAttribute}=\"true\" on your Reflex Controller Element or pass { serializeForm: true } as an option to stimulate.`
          )
        const formData =
          options['serializeForm'] === false
            ? ''
    ...
    __perform (event) {
      ...
      while (element && !reflex) {
        reflex = element.getAttribute(javascript_reflexes.app.schema.reflexAttribute)
...
/* harmony default export */ const stimulus_reflex = ({
  initialize: stimulus_reflex_initialize,
  register,
  useReflex,
  get debug () {
  ...
  get deprecate () {
    return javascript_deprecate.value
  },
  set deprecate (value) {
    javascript_deprecate.set(!!value)
  }
});
...
/* harmony export */ });
/* harmony import */ var stimulus__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(931);
/* harmony import */ var stimulus_reflex__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(360);



class NewClientFormController extends stimulus__WEBPACK_IMPORTED_MODULE_0__/* .Controller */ .Qr {
  connect() {
    stimulus_reflex__WEBPACK_IMPORTED_MODULE_1__/* .default.register */ .Z.register(this)
  }
...
// EXTERNAL MODULE: ./node_modules/stimulus/index.js + 38 modules
var stimulus = __webpack_require__(931);
// EXTERNAL MODULE: ./node_modules/stimulus_reflex/javascript/stimulus_reflex.js + 23 modules
var stimulus_reflex = __webpack_require__(360);
...
// EXTERNAL MODULE: ./sscs/javascript/controllers.js
var controllers = __webpack_require__(398);
;// CONCATENATED MODULE: ./sscs/javascript/index.js
...
stimulus_reflex/* default.initialize */.Z.initialize(application, {debug: true })
